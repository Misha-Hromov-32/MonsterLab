...
from ..core import metrics, saliency, shelf
from ..core.imaging import encode_grid
...
def _analyze(rgb: np.ndarray) -> dict:
...
async def analyze(file: UploadFile = File(...)) -> dict:
    ...
    return {"id": image_id, **await asyncio.to_thread(_analyze, rgb)}
